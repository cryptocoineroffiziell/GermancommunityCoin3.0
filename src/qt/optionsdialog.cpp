    ...
    mapper(0)
{
    ...
    ui->theme->addItem(QString("GCC-light"), QVariant("light"));
    ui->theme->addItem(QString("GCC-light-hires"), QVariant("light-hires"));
    ui->theme->addItem(QString("GCC-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("GCC-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("GCC-traditional"), QVariant("trad"));
