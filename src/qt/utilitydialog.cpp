    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("GermanCC Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About GermanCC Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  germancc-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the GermanCC in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 GCC, 0.1 GCC, 1 GCC and 10 GCC -- sort of like the paper money you use every day.</li> \
...
For more info see <a href=\"https://germanccpay.atlassian.net/wiki/display/DOC/PrivateSend\">https://germanccpay.atlassian.net/wiki/display/DOC/PrivateSend</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("GermanCC Core is shutting down...") + "<br /><br />" +
